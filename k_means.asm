...
add t0, t0, s0
addi t0, t0, -264
flw ft3, 0(t0) # centroids_x[0]

lw t0, -116(s0)
slli t0, t0, 2
add t0, t0, s0
addi t0, t0, -108
flw ft4, 0(t0) # points_x[i]

fsub.s ft2, ft3, ft4 # sub operations
...
add t0, t0, s0
addi t0, t0, -252
flw ft4, 0(t0) # centroids_y[0]

lw t0, -116(s0)
slli t0, t0, 2
add t0, t0, s0
addi t0, t0, -72
flw ft5, 0(t0) # points_y[i]

fsub.s ft3, ft4, ft5 # sub operations
abs ft2, ft3 # abs value
...
fsub.s ft2, ft3, ft4 # sub operation
abs ft1, ft2 # abs value
...
fsub.s ft3, ft4, ft5 # sub operation
abs ft2, ft3 # abs value
...
add t0, t0, s0
addi t0, t0, -264
flw ft2, 0(t0) # centroids_x[i]

lw t0, -116(s0)
slli t0, t0, 2
add t0, t0, s0
addi t0, t0, -240
flw ft3, 0(t0) # old_centroids_x[o]
...
add t0, t0, s0
addi t0, t0, -252
flw ft2, 0(t0) # centroids_y[i]

lw t0, -116(s0)
slli t0, t0, 2
add t0, t0, s0
addi t0, t0, -228
flw ft3, 0(t0) # old_centroids_y[i]
...
flw ft2, -36(s0)
lui s7, %hi(.LC18)
flw ft3, %lo(.LC18)(s7) # Loading 0.000001
flt.s ft1, ft2, ft3  # side1 < 0.000001

flw ft3, -32(s0)
lui s7, %hi(.LC19)
flw ft4, %lo(.LC19)(s7)
flt.s ft2, ft3, ft4 # side2 < 0.000001
